...
```sh
git clone https://github.com/aviii06/nvim-basic-ide.git ~/.config/nvim
```

Run `nvim` and wait for the plugins to be installed
Then run `:checkhealth` and `:PackerSync`

**NOTE** (You will notice treesitter pulling in a bunch of parsers the next time you open Neovim) 

**NOTE** Checkout this file for some predefined keymaps: [keymaps](https://github.com/aviii06/nvim-basic-ide/blob/master/lua/user/keymaps.lua)
